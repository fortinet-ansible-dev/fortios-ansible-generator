...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify system feature and vmlicense category.
...
def filter_system_vmlicense_data(json):
    option_list = ['file_content']
    dictionary = {}
...
def system_vmlicense(data, fos):
    vdom = data['vdom']
    system_vmlicense_data = data['system_vmlicense']
    filtered_data = underscore_to_hyphen(filter_system_vmlicense_data(system_vmlicense_data))
...
def fortios_system(data, fos):
    ...
    if data['system_vmlicense']:
        resp = system_vmlicense(data, fos)
